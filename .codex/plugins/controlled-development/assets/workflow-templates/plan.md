...
Mỗi task schema 4 phải tạo contract tương ứng trong `execution-policy.json`: `allowedWritePaths`,
`allowedNewFiles`, `protectedPaths`, `commandGrants`, và `requiredChecks`.
